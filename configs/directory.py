...
config_directory["data_singletable"] = str(
    "/storage/store3/work/mkim/codes/carte/data/data_singletable/"
)
...
config_directory["fasttext"] = (
    "/storage/store3/work/mkim/codes/carte/data/etc/cc.en.300.bin"
)
